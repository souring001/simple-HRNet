...
IMAGE_DIR = os.path.join(ROOT_DIR, DIR+'_mask_pers')
OUT_DIR = os.path.join(ROOT_DIR, DIR+'_hrnet_pers')
...
path_p = os.path.join(ROOT_DIR, 'hrnet_2d_pos_pers.csv')
path_w = os.path.join(ROOT_DIR, DIR+'_pelvis_pers.csv')
